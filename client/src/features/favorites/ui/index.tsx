            ...
            <div className="bg-gray-50 border-b border-gray-100 py-16 md:py-20">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-gray-500 max-w-lg mx-auto">
                        Siz yoqtirgan mahsulotlar ro'yxati. Ularni keyinroq sotib olish uchun saqlab qo'ydik.
                    </p>
                </div>
            </div>
            ...
            <div className="section-padding container mx-auto px-4">
                {favoriteProducts.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <h2 className="text-2xl font-bold text-black mb-3">Sevimlilar ro'yxati bo'sh</h2>
                        <p className="text-gray-500 mb-8 max-w-sm">
                            Siz hali hech qanday mahsulotni sevimlilar ro'yxatiga qo'shmagansiz.
                        </p>
                        <Link href="/shop">
