...
export default function TermsAndConditions() {
    const sections = [
        ...
        },
        {
            ...
            isImportant: true,
            content: "Mahsulotlar Uzpost pochta xizmati orqali yetkazib beriladi va yetkazib berish ikki bosqichdan iborat:",
            stages: [
                {
                    title: "1-bosqich:",
                    items: [
            ...
            warning: "Foydalanuvchi yetkazib berish muddati asosan 1-bosqichga bog'liqligini tushunib, bunga rozilik bildiradi."
        },
        {
            id: 5,
            icon: Clock,
            ...
            list: [
                "Yetkazib berish muddati taxminiy hisoblanadi."
            ],
        ...
        },
        {
            ...
            list: [
                "noto'g'ri yuborilgan bo'lsa",
                "jiddiy nuqson bilan yetib kelsa"
            ],
        ...
        },
        {
            ...
            content: "Platforma ushbu Foydalanish shartlarini istalgan vaqtda o'zgartirish huquqiga ega.",
            ...
            <div className="container mx-auto px-4 max-w-4xl py-12">
                <div className="bg-amber-50 border-l-4 border-amber-600 p-6 rounded-r-lg mb-12">
                    <p className="text-gray-800 leading-relaxed font-medium">
                        Platformadan foydalanish orqali siz ushbu shartlarga rozilik bildirasiz va ularni bajarishga majbursiz.
                    </p>
                </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+998905661107" className="text-white hover:text-gray-300 transition-colors">
                                    +998 90 566 11 07
                                </a>
                            </div>
                        </div>
