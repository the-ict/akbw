      ...
      <div className="container py-10 px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-20 mb-20">
              ...
              {productImages.map((img, idx) => (
                <div
                  ...
                  className={cn(
                    ...
                    activeImage === idx
                      ? 'border-black shadow-lg scale-95'
          ...
          <div className="flex flex-col">
            <h1
              className={cn(
                'text-4xl md:text-5xl lg:text-5.5xl font-black uppercase mb-4 leading-tight',
          ...
          {activeTab === 'faqs' && (
            <div className="max-w-4xl mx-auto space-y-4">
              {[
                ...
                <div
                  key={i}
                  className="p-6 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors cursor-pointer group"
                >
        ...
        <div className="mt-32 border-t border-gray-100 pt-32 pb-20">
          <h2
            className={cn(
              'text-4xl md:text-5xl lg:text-6xl font-black text-center uppercase mb-20 tracking-tighter',
              monsterrat.className,
            )}
          >
