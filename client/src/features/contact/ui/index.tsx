...
import { Mail, Phone, MapPin, Globe, Instagram, Send, Clock, Facebook } from 'lucide-react';
...
export default function ContactPage() {
    ...
    const socials = [
        { icon: Send, name: "Telegram", link: "https://t.me/akbwuz", color: "hover:text-blue-500" },
        { icon: Instagram, name: "Instagram", link: "https://instagram.com/akbw.uz", color: "hover:text-pink-600" },
        ...
        <div className="min-h-screen bg-gray-50 text-black font-sans">
            ...
            <div className="bg-white border-b border-gray-100">
                <div className="container mx-auto px-6 py-16 md:py-24 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">Bog'lanish</h1>
                    <p className="text-xl text-gray-500 max-w-2xl mx-auto font-light">
                        Savollaringiz bormi yoki hamkorlik qilmoqchimisiz? Biz bilan aloqaga chiqing.
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-6 py-12 -mt-10 md:-mt-16 relative z-10">
                <div className="grid md:grid-cols-3 gap-6 md:gap-8">
                    {contactMethods.map((method, idx) => (
                        <div key={idx} className="bg-white p-8 rounded-2xl shadow-lg shadow-gray-100/50 border border-gray-100 flex flex-col items-center text-center hover:translate-y-[-5px] transition-transform duration-300">
                            ...
                            {method.action ? (
                                <a href={method.action} className="text-lg font-medium hover:text-blue-600 transition-colors mb-2">
                                    {method.value}
                                </a>
                            ) : (
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-gray-600 text-lg mb-8">
                                Yangiliklar, aksiyalar va yangi to'plamlardan xabardor bo'lish uchun bizni kuzatib boring.
                            </p>
                        ...
                        <div className="bg-neutral-900 text-white p-8 rounded-2xl mt-8">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-white text-xl font-medium mt-1">09:00 - 18:00</p>
                                    <p className="text-neutral-500 text-sm mt-3">Yakshanba - Dam olish kuni</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-8 md:p-10 rounded-2xl border border-gray-100">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                <h4 className="font-semibold text-lg mb-2">Hamkorlik bo'yicha kimga murojaat qilish kerak?</h4>
                                <p className="text-gray-600">
                                    Tijoriy takliflar uchun <a href="mailto:akbw.uz@gmail.com" className="text-black font-medium underline">akbw.uz@gmail.com</a> elektron pochta manziliga yozishingiz mumkin.
                                </p>
                            </div>
                        </div>
