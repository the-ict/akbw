...
import { getHelpChat, sendHelpMessage, createHelpChat, getAskChat, sendAskMessage, createAskChat } from "@/shared/config/api/profile/profile.requests";
...
export const useSupportChat = () => {
    ...
    return { ...query, sendMessage: sendMessageMutation.mutateAsync, createChat: createChatMutation.mutateAsync };
}
